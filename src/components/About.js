...
// })
//         }
mystyle.color ==='black' ? setStyle({ color:'white',backgroundColor:'black'}): setStyle({
        color:'black',
        backgroundColor:'white'
    })
    ...
    return (
        <>
            <div className=' cotainer mt-5'  style={mystyle}>
                <h1>About us</h1>
                ...
                <button className='btn btn-primary my-3'onClick={onChange}>enable dark mode</button>
            </div>
